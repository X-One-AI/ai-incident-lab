...
2. Confirm the release tag exists, for example `v0.2.0`.
...
```bash
python3 -m pip install https://github.com/X-One-AI/ai-incident-lab/releases/download/v0.2.0/xone_ai_incident_lab-0.2.0-py3-none-any.whl
